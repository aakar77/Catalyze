        ...
        <nav class="navbar navbar-inverse navbar-fixed-top" role="navigation">
            ...
            <div class="collapse navbar-collapse navbar-ex1-collapse">
                <ul class="nav navbar-nav side-nav">
                    ...
                    <li class="active">
                        <a href="dashboard2.php"><i class="fa fa-fw fa-share"></i>Your Sponsored Projects</a>
                    </li>
                    <li>
                        <a href="dashboard3.php"><i class="fa fa-fw fa-edit"></i>Create a New Project</a>
                    </li>
                    
                    <li>
                        <a href="forms.html"><i class="fa fa-fw fa-money"></i>Projects Liked</a>
                    </li>
                    <li>
                        <a href="forms.html"><i class="fa fa-fw fa-money"></i>User's Followed</a>
                    </li>
                    <li>
                        <a href="bootstrap-elements.html"><i class="fa fa-fw fa-desktop">Search a Projects</i></a>
                    </li>
                    <li>
                        <a href="blank-page.html"><i class="fa fa-fw fa-file"></i>Update Project</a>
                    </li>
                    <li>
                        <a href="blank-page.html"><i class="fa fa-fw fa-edit"></i>View Your Profile</a>
                    </li>
                </ul>
            </div>
            <!-- /.navbar-collapse -->
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <h1 class="page-header">
                           <i class="fa fa-dashboard"></i>Your Sponsored Projects <!-- <small>Projects Overview</small> -->
                        </h1>
                        <!--
                        <ol class="breadcrumb">
                            <li class="active">
