...
<?php 
    ...
    $sql="Select COUNT(*) AS nosponsored from project p where p.projid IN (SELECT DISTINCT s.projid FROM sponsor s WHERE s.uid=".$c_uid.")";

    $fetch=mysqli_query($con,$sql);
    $row=mysqli_fetch_array($fetch);

    $sponcount = $row['nosponsored'];
                ...
                <div class="row">
                    <div class="col-lg-7 col-md-7">
                        <h1 class="page-header">
                           <i class="fa fa-share"></i>Your Sponsored Project's <!-- <small>Projects Overview</small> -->
                        </h1>
                    </div>
                    <div class="col-lg-5 col-md-5">
                        <h1 class="page-header">
                            <i class="fa fa-unchecked"></i>No. Project Sponsored : <?php echo $sponcount; ?>
                        </h1> 
                    </div>
                </div>
                <!-- /.row -->
