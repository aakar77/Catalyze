                ...
                <div class="row">
                    <div class="col-lg-8 col-md-8">
                        <h1 class="page-header">
                           <i class="fa fa-arrow-right"></i>You are following <!-- <small>Projects Overview</small> -->
                        </h1>
                    </div>
                    <div class="col-lg-4 col-md-4">
                        <h1 class="page-header">
                            <i class="fa fa-unchecked"></i>No. Users Followed : <?php echo $noOfFollowers; ?>
                        </h1> 
                    </div>
                </div>
                <!-- /.row -->
...
<div class="jumbotron">
    <h2>
        ...
        <div class="alert alert-danger">
            <strong>You are not following any user</strong>
            <br />
            <br />
            <br />
            <br />
